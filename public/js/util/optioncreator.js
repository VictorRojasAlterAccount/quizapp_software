...
$(document).ready(function() {
    instanceOptionsCreator();
});

function instanceOptionsCreator() {
...
function addItem() {
    ...
    <div style="width: 10%;" class="total-height">
        <div>
            <a class="right list__delete-btn">&times;</a>                
        </div>

        <div style="margin-top:110%; margin-left: 35%">
