function databaseSetup(sql) {
    ...
    sql.prepare("CREATE TABLE IF NOT EXISTS classification (studentUsername TEXT, veryHigh INTEGER, high INTEGER, medium INTEGER, low INTEGER, veryLow INTEGER)").run();
